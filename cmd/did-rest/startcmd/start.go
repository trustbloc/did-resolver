...
import (
	...
	"github.com/trustbloc/did-resolver/cmd/common"
	"github.com/trustbloc/did-resolver/pkg/proxy/rules/filerules"
	"github.com/trustbloc/did-resolver/pkg/restapi/did"
...
func createStartCmd(srv server) *cobra.Command {
	return &cobra.Command{
		...
		Long:  "Start did-rest inside the did-resolver",
